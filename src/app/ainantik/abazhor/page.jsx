...
const products = [
  {
    id: 1,
    title: 'آباژور کلاسیک',
    description: 'آباژور کلاسیک با طراحی سنتی و نورپردازی زیبا',
    price: '۱,۸۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
    size: 'ارتفاع ۴۵ سانتی‌متر',
    material: 'چوب و پارچه',
    style: 'کلاسیک',
    inStock: true
  },
  {
    id: 2,
    title: 'آباژور مدرن',
    description: 'آباژور مدرن با طراحی مینیمال و نورپردازی مدرن',
    price: '۲,۲۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
    size: 'ارتفاع ۵۰ سانتی‌متر',
    material: 'فلز و شیشه',
    style: 'مدرن',
    inStock: true
  },
  {
    id: 3,
    title: 'آباژور تزئینی',
    description: 'آباژور تزئینی با نقوش هنری و رنگ‌آمیزی دستی',
    price: '۲,۵۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
  ...
  },
  {
    id: 4,
    title: 'آباژور رومیزی',
    description: 'آباژور رومیزی با طراحی زیبا و نورپردازی ملایم',
    price: '۱,۵۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
  ...
  },
  {
    id: 5,
    title: 'آباژور دیواری',
    description: 'آباژور دیواری با طراحی خاص و نورپردازی مستقیم',
    price: '۱,۹۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
  ...
  },
  {
    ...
    description: 'آباژور ایستاده با طراحی لوکس و نورپردازی قوی',
    price: '۳,۲۰۰,۰۰۰',
    image: '/api/placeholder/300/400',
    size: 'ارتفاع ۶۰ سانتی‌متر',
    material: 'چوب و فلز',
    style: 'ایستاده',
    inStock: true
  }
...
const styles = [
  ...
  { name: 'ایستاده', icon: '🏮', description: 'آباژور ایستاده' }
];

export default function AbazhorPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20">
      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center space-x-2 space-x-reverse text-sm text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-foreground">آباژور</span>
        </nav>
      </div>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 animate-fade-in-up">
            مجموعه‌ای منحصر به فرد از آباژورهای آینانتیک که برای نورپردازی زیبا و تزئین خانه طراحی شده‌اند. 
            هر آباژور با دقت و ظرافت خاصی ساخته شده تا زیبایی و نور را به فضای شما بیاورد.
          </p>
      ...
      <section className="py-16 px-4 bg-secondary/10">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-foreground">
            ویژگی‌های آباژورهای آینانتیک ما
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                هر آباژور با طراحی خاص و منحصر به فرد ساخته می‌شود
              </p>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🏆</div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 golden-text">
            آباژور مورد نظر خود را پیدا نکردید؟
          </h2>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            می‌توانید آباژور اختصاصی خود را با طراحی و اندازه دلخواه سفارش دهید
          </p>
